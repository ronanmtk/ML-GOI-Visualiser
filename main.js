requirejs.config({
    ...
    bundles: {
        'parser/ast': ['ast/abstraction', 'ast/application', 'ast/identifier'
                     ...
                     , 'ast/binary-op', 'ast/if-then-else', 'ast/pair'
                     , 'ast/pair-op', 'ast/recursion', 'ast/list'
                     , 'ast/empty-list', 'ast/cons', 'ast/list-op'],
        'group': ['group', 'displayed-group', 'box'
                , 'copyable-box', 'pair-box', 'empty-list-box'
                , 'cons-box', 'pair-op-box', 'list-op-box'],
